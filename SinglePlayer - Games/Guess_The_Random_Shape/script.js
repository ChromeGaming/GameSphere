...
correct.src = 'https://drive.google.com/uc?export=download&id=1zZHbTCgTHG_wGYk6ir_Rc4An-vL70ubd';

const wrong = new Audio();
wrong.src = 'https://drive.google.com/uc?export=download&id=1hI9DPEwRic_zQOxaknoffAHR4Qg27EyI';

const win = new Audio();
win.src = 'https://drive.google.com/uc?export=download&id=1DBRbc6x56SvfO1prnNhob6K5cVN_uaTO';

const loose = new Audio();
loose.src = 'https://drive.google.com/uc?export=download&id=1F0dr1NTXDF-J_rJvNPUa_T8DPuuv4a7a';
