...
// Generate a new puzzle with "easy" difficulty
var newPuzzle = sudoku.generate("easy");

// Update the board variable with the new puzzle
var board = sudoku.board_string_to_grid(newPuzzle);

// Solve the new puzzle
var solvedPuzzle = sudoku.solve(newPuzzle);

// Update the solution variable with the solved puzzle
var solution = sudoku.board_string_to_grid(solvedPuzzle);
...
function startGame() {
    // Get the selected difficulty level from the dropdown menu
    var difficulty = document.getElementById("difficulty").value;
   
    // Generate a new puzzle with the selected difficulty level
    var newPuzzle = sudoku.generate(difficulty);
    board = sudoku.board_string_to_grid(newPuzzle);
    var solvedPuzzle = sudoku.solve(newPuzzle);
    solution = sudoku.board_string_to_grid(solvedPuzzle);
